...
// Add initial simulated data for testing (just a few points)
void Simulation::addSimulatedData() {
    // Add just 5 seconds of simulated data initially
    m_timestamp = 1000; // Start with a non-zero timestamp
